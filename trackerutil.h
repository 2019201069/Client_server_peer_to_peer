...
//unordered_map<string, set< pair<string, int> > > pendingreq;
//unordered_map<string, set< pair<int, string> > > fileswithgroupsandclients;
//unordered_map<string, set< filesupload > > fileswithgroupsandclients;
...
// filename and respective set of group that can access the
...
// void send_upload_file_info(int option, string ip, string port, string path, int groupid){

// 	params = params + option_s + col + ip + col + port + col + path + col + groupid_s + col + u_name_g + col; 

// }
               
// void send_download_file_info(int option, string ip, string port, string spath, string dpath, int groupid){
...
// 	params = params + option_s + col + ip + col + port + col +  groupid_s + col + path + col + u_name_g + col; 
